...
**全年级 · 全学科**教育问题的**多机器人头脑风暴工作流**：5 位 AI 教育专家按「小组发散 → 全师评审 → 迭代深化 → 终审把关」闭环协作，产出有理论根基、可落地的创意方案，并交付为可上课的互动课堂。

## 🎯 适用场景（不限年级、不限学科）

| 学段 | 覆盖 |
|---|---|
| 🏫 幼儿园 / 小学 / 初中 / 高中 | 各学段课程与教学 |
| 📚 全学科 | 语文 / 数学 / 英语 / 科学 / 物理 / 化学 / 生物 / 历史 / 地理 / 道法 / 音体美… |
| 🧠 内容知识 | 概念学习、知识点讲解、题型训练、知识扩展、跨学科融合 |
| 🎯 教育事务 | 课题规划、教学设计、学习应用、活动方案、评价体系、题型创意、教案评改 |
...
- **5 位教育专家机器人**，角色互补：
  ...
  - 🔍 评课吴老师（edu-reviewer）：质量评审 + 终审总把关 + 执行交付
- **多轮闭环流程**：创意小组先内部激烈碰撞（点子哥 × 苏博士）→ 全师评审可行性 → 小组迭代深化 → 吴老师终审裁决
- **直产交付**：方案定稿后直接交给 OpenMAIC 生成互动课堂（含 TTS 语音），制作不停、逐节回报进度
- **交付质检环**：OpenMAIC 生成后 3 位老师自动质检（质量/落地/内容），合格才交付
