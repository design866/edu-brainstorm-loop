...
hermes -p edu-brains chat --in "$HOME_DIR" -c "$SESS" --create-if-missing -Q -q \
...
hermes -p edu-pedagogy chat --in "$HOME_DIR" -c "$SESS" --create-if-missing -Q -q \
